...
<div id="app">
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="main-content">
            ...
            <div class="col-12 col-md-10=10 col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-striped table-md">
                                ...
                                @foreach($course as $contents)
                                <tbody>
                                <tr>

                                    <td>{{$contents->Course_Title}}</td>
                                    <td>{{$contents->Course_Content}}</td>
                                    <td>{{$contents->club}}</td>
                                    <td>{{$contents->created_at}}</td>
                                    <td>
                                        <a href="{{url('/EditMaterial/'.$contents->Course_Title)}}" class="btn btn-success " style="color: white; margin-top: 5px"><i class="fa fa-edit"></i></a>
{{--                                        <a href="{{url('/DeleteMaterial/'.$contents->Course_Title)}}" class="btn btn-danger">Delete</a>--}}
                                        <form action="{{ route('deleteMaterial') }}"  method="post">
                                            @csrf
                                            <input type="hidden" name="club" value="{{ Auth::user()->clubname}}">
                                            <input type="hidden" name="id" value="{{$contents->id}}">
                                            <input type="hidden" name="content" value="{{$contents->Course_Content}}">
                                            <button type="submit" class="btn btn-danger fa fa-pencil-ruler" style=" color: white; border: white; margin-top: 2px; "></button>
                                        </form>
                                    </td>
